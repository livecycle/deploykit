...
import { ObjectMeta,Time} from "../../../apimachinery/pkg/apis/meta/v1/mod.ts"
...
export function createTokenRequest(data:Omit<TokenRequest, "apiVersion" | "kind">):TokenRequest{
  return {apiVersion: "authentication.k8s.io/v1", kind: "TokenRequest", ...data}
}
...
export function createTokenReview(data:Omit<TokenReview, "apiVersion" | "kind">):TokenReview{
  return {apiVersion: "authentication.k8s.io/v1", kind: "TokenReview", ...data}
}
