...
import { TopologySelectorTerm,PersistentVolumeSpec} from "../../core/v1/mod.ts"
import { ObjectMeta,ListMeta,Time} from "../../../apimachinery/pkg/apis/meta/v1/mod.ts"
...
export function createCSIDriver(data:Omit<CSIDriver, "apiVersion" | "kind">):CSIDriver{
...
export function createCSIDriverList(data:Omit<CSIDriverList, "apiVersion" | "kind">):CSIDriverList{
  return {apiVersion: "storage.k8s.io/v1beta1", kind: "CSIDriverList", ...data}
}
...
export function createCSINode(data:Omit<CSINode, "apiVersion" | "kind">):CSINode{
...
export function createCSINodeList(data:Omit<CSINodeList, "apiVersion" | "kind">):CSINodeList{
...
export function createStorageClass(data:Omit<StorageClass, "apiVersion" | "kind">):StorageClass{
  return {apiVersion: "storage.k8s.io/v1beta1", kind: "StorageClass", ...data}
}
...
export function createStorageClassList(data:Omit<StorageClassList, "apiVersion" | "kind">):StorageClassList{
  return {apiVersion: "storage.k8s.io/v1beta1", kind: "StorageClassList", ...data}
}
...
export function createVolumeAttachment(data:Omit<VolumeAttachment, "apiVersion" | "kind">):VolumeAttachment{
  return {apiVersion: "storage.k8s.io/v1beta1", kind: "VolumeAttachment", ...data}
}
...
export function createVolumeAttachmentList(data:Omit<VolumeAttachmentList, "apiVersion" | "kind">):VolumeAttachmentList{
  return {apiVersion: "storage.k8s.io/v1beta1", kind: "VolumeAttachmentList", ...data}
}
