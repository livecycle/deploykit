...
export function createEndpointSlice(data:Omit<EndpointSlice, "apiVersion" | "kind">):EndpointSlice{
  return {apiVersion: "discovery.k8s.io/v1beta1", kind: "EndpointSlice", ...data}
}
...
export function createEndpointSliceList(data:Omit<EndpointSliceList, "apiVersion" | "kind">):EndpointSliceList{
  return {apiVersion: "discovery.k8s.io/v1beta1", kind: "EndpointSliceList", ...data}
}
