...
export function createCronJob(data:Omit<CronJob, "apiVersion" | "kind">):CronJob{
...
export function createCronJobList(data:Omit<CronJobList, "apiVersion" | "kind">):CronJobList{
