...
import { ObjectMeta,ListMeta,Time,MicroTime,LabelSelector} from "../../../apimachinery/pkg/apis/meta/v1/mod.ts"
...
export function createBinding(data:Omit<Binding, "apiVersion" | "kind">):Binding{
...
export function createComponentStatus(data:Omit<ComponentStatus, "apiVersion" | "kind">):ComponentStatus{
...
export function createComponentStatusList(data:Omit<ComponentStatusList, "apiVersion" | "kind">):ComponentStatusList{
...
export function createConfigMap(data:Omit<ConfigMap, "apiVersion" | "kind">):ConfigMap{
...
export function createConfigMapList(data:Omit<ConfigMapList, "apiVersion" | "kind">):ConfigMapList{
...
export function createEndpoints(data:Omit<Endpoints, "apiVersion" | "kind">):Endpoints{
...
export function createEndpointsList(data:Omit<EndpointsList, "apiVersion" | "kind">):EndpointsList{
...
export function createEventList(data:Omit<EventList, "apiVersion" | "kind">):EventList{
...
export function createLimitRange(data:Omit<LimitRange, "apiVersion" | "kind">):LimitRange{
...
export function createLimitRangeList(data:Omit<LimitRangeList, "apiVersion" | "kind">):LimitRangeList{
...
export function createNamespace(data:Omit<Namespace, "apiVersion" | "kind">):Namespace{
...
export function createNamespaceList(data:Omit<NamespaceList, "apiVersion" | "kind">):NamespaceList{
...
export function createNodeList(data:Omit<NodeList, "apiVersion" | "kind">):NodeList{
...
export function createPersistentVolume(data:Omit<PersistentVolume, "apiVersion" | "kind">):PersistentVolume{
...
export function createPersistentVolumeClaim(data:Omit<PersistentVolumeClaim, "apiVersion" | "kind">):PersistentVolumeClaim{
...
export function createPersistentVolumeClaimList(data:Omit<PersistentVolumeClaimList, "apiVersion" | "kind">):PersistentVolumeClaimList{
...
export function createPersistentVolumeList(data:Omit<PersistentVolumeList, "apiVersion" | "kind">):PersistentVolumeList{
...
export function createPodList(data:Omit<PodList, "apiVersion" | "kind">):PodList{
...
[key:string]: string
  ...
  /** Overhead represents the resource overhead associated with running a pod for a given RuntimeClass. This field will be autopopulated at admission time by the RuntimeClass admission controller. If the RuntimeClass admission controller is enabled, overhead must not be set in Pod create requests. The RuntimeClass admission controller will reject Pod create requests which have the overhead already set. If RuntimeClass is configured and selected in the PodSpec, Overhead will be set to the value defined in the corresponding RuntimeClass, otherwise it will remain unset and treated as zero. More info: https:git.k8s.ioenhancementskepssig-node20190226-pod-overhead.md This field is alpha-level as of Kubernetes v1.16, and is only honored by servers that enable the PodOverhead feature. */
  overhead?:{
...
export function createPodTemplate(data:Omit<PodTemplate, "apiVersion" | "kind">):PodTemplate{
...
export function createPodTemplateList(data:Omit<PodTemplateList, "apiVersion" | "kind">):PodTemplateList{
...
export function createReplicationController(data:Omit<ReplicationController, "apiVersion" | "kind">):ReplicationController{
...
export function createReplicationControllerList(data:Omit<ReplicationControllerList, "apiVersion" | "kind">):ReplicationControllerList{
...
export function createResourceQuota(data:Omit<ResourceQuota, "apiVersion" | "kind">):ResourceQuota{
...
export function createResourceQuotaList(data:Omit<ResourceQuotaList, "apiVersion" | "kind">):ResourceQuotaList{
...
export function createSecret(data:Omit<Secret, "apiVersion" | "kind">):Secret{
...
export function createSecretList(data:Omit<SecretList, "apiVersion" | "kind">):SecretList{
...
export function createService(data:Omit<Service, "apiVersion" | "kind">):Service{
...
export function createServiceAccount(data:Omit<ServiceAccount, "apiVersion" | "kind">):ServiceAccount{
...
export function createServiceAccountList(data:Omit<ServiceAccountList, "apiVersion" | "kind">):ServiceAccountList{
...
export function createServiceList(data:Omit<ServiceList, "apiVersion" | "kind">):ServiceList{
