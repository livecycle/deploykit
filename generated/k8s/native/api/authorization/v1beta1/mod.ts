/* Generated for api/authorization/v1beta1/mod.ts */
...
export function createLocalSubjectAccessReview(data:Omit<LocalSubjectAccessReview, "apiVersion" | "kind">):LocalSubjectAccessReview{
  return {apiVersion: "authorization.k8s.io/v1beta1", kind: "LocalSubjectAccessReview", ...data}
}
...
export function createSelfSubjectAccessReview(data:Omit<SelfSubjectAccessReview, "apiVersion" | "kind">):SelfSubjectAccessReview{
  return {apiVersion: "authorization.k8s.io/v1beta1", kind: "SelfSubjectAccessReview", ...data}
}
...
export function createSelfSubjectRulesReview(data:Omit<SelfSubjectRulesReview, "apiVersion" | "kind">):SelfSubjectRulesReview{
  return {apiVersion: "authorization.k8s.io/v1beta1", kind: "SelfSubjectRulesReview", ...data}
}
...
export function createSubjectAccessReview(data:Omit<SubjectAccessReview, "apiVersion" | "kind">):SubjectAccessReview{
  return {apiVersion: "authorization.k8s.io/v1beta1", kind: "SubjectAccessReview", ...data}
}
