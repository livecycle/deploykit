...
import { TypedLocalObjectReference,LoadBalancerStatus} from "../../core/v1/mod.ts"
...
export function createIngress(data:Omit<Ingress, "apiVersion" | "kind">):Ingress{
...
export function createIngressClass(data:Omit<IngressClass, "apiVersion" | "kind">):IngressClass{
  return {apiVersion: "networking.k8s.io/v1beta1", kind: "IngressClass", ...data}
}
...
export function createIngressClassList(data:Omit<IngressClassList, "apiVersion" | "kind">):IngressClassList{
  return {apiVersion: "networking.k8s.io/v1beta1", kind: "IngressClassList", ...data}
}
...
export function createIngressList(data:Omit<IngressList, "apiVersion" | "kind">):IngressList{
  return {apiVersion: "networking.k8s.io/v1beta1", kind: "IngressList", ...data}
}
