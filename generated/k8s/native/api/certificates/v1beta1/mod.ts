...
export function createCertificateSigningRequest(data:Omit<CertificateSigningRequest, "apiVersion" | "kind">):CertificateSigningRequest{
  return {apiVersion: "certificates.k8s.io/v1beta1", kind: "CertificateSigningRequest", ...data}
}
...
export function createCertificateSigningRequestList(data:Omit<CertificateSigningRequestList, "apiVersion" | "kind">):CertificateSigningRequestList{
  return {apiVersion: "certificates.k8s.io/v1beta1", kind: "CertificateSigningRequestList", ...data}
}
