...
import { DeleteOptions,ObjectMeta,ListMeta,LabelSelector,Time} from "../../../apimachinery/pkg/apis/meta/v1/mod.ts"
...
export function createEviction(data:Omit<Eviction, "apiVersion" | "kind">):Eviction{
...
export function createPodDisruptionBudget(data:Omit<PodDisruptionBudget, "apiVersion" | "kind">):PodDisruptionBudget{
...
export function createPodDisruptionBudgetList(data:Omit<PodDisruptionBudgetList, "apiVersion" | "kind">):PodDisruptionBudgetList{
  return {apiVersion: "policy/v1beta1", kind: "PodDisruptionBudgetList", ...data}
}
...
export function createPodSecurityPolicy(data:Omit<PodSecurityPolicy, "apiVersion" | "kind">):PodSecurityPolicy{
...
export function createPodSecurityPolicyList(data:Omit<PodSecurityPolicyList, "apiVersion" | "kind">):PodSecurityPolicyList{
  return {apiVersion: "policy/v1beta1", kind: "PodSecurityPolicyList", ...data}
}
