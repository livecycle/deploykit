...
import { ObjectMeta,Time,ListMeta} from "../../../apimachinery/pkg/apis/meta/v1/mod.ts"
...
export type FlowSchema = {
  ...
  /** `spec` is the specification of the desired behavior of a FlowSchema. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
  spec?:FlowSchemaSpec;
...
export function createFlowSchema(data:Omit<FlowSchema, "apiVersion" | "kind">):FlowSchema{
  return {apiVersion: "flowcontrol.apiserver.k8s.io/v1alpha1", kind: "FlowSchema", ...data}
}
...
export function createFlowSchemaList(data:Omit<FlowSchemaList, "apiVersion" | "kind">):FlowSchemaList{
  return {apiVersion: "flowcontrol.apiserver.k8s.io/v1alpha1", kind: "FlowSchemaList", ...data}
}
...
export type PriorityLevelConfiguration = {
  ...
  /** `spec` is the specification of the desired behavior of a "request-priority". More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
...
export function createPriorityLevelConfiguration(data:Omit<PriorityLevelConfiguration, "apiVersion" | "kind">):PriorityLevelConfiguration{
  return {apiVersion: "flowcontrol.apiserver.k8s.io/v1alpha1", kind: "PriorityLevelConfiguration", ...data}
}
...
export function createPriorityLevelConfigurationList(data:Omit<PriorityLevelConfigurationList, "apiVersion" | "kind">):PriorityLevelConfigurationList{
  return {apiVersion: "flowcontrol.apiserver.k8s.io/v1alpha1", kind: "PriorityLevelConfigurationList", ...data}
}
