...
import { LabelSelector,ObjectMeta,Time,ListMeta} from "../../../apimachinery/pkg/apis/meta/v1/mod.ts"
...
export function createHorizontalPodAutoscaler(data:Omit<HorizontalPodAutoscaler, "apiVersion" | "kind">):HorizontalPodAutoscaler{
  return {apiVersion: "autoscaling/v2beta1", kind: "HorizontalPodAutoscaler", ...data}
}
...
export function createHorizontalPodAutoscalerList(data:Omit<HorizontalPodAutoscalerList, "apiVersion" | "kind">):HorizontalPodAutoscalerList{
  return {apiVersion: "autoscaling/v2beta1", kind: "HorizontalPodAutoscalerList", ...data}
}
