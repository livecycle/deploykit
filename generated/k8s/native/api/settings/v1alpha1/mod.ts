...
import { EnvVar,EnvFromSource,VolumeMount,Volume} from "../../core/v1/mod.ts"
...
export function createPodPreset(data:Omit<PodPreset, "apiVersion" | "kind">):PodPreset{
...
export function createPodPresetList(data:Omit<PodPresetList, "apiVersion" | "kind">):PodPresetList{
  return {apiVersion: "settings.k8s.io/v1alpha1", kind: "PodPresetList", ...data}
}
