/* Generated for api/coordination/v1beta1/mod.ts */
import { ObjectMeta,ListMeta,MicroTime} from "../../../apimachinery/pkg/apis/meta/v1/mod.ts"
export type Lease = {
...
export function createLeaseList(data:Omit<LeaseList, "apiVersion" | "kind">):LeaseList{
  return {apiVersion: "coordination.k8s.io/v1beta1", kind: "LeaseList", ...data}
}
