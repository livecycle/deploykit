...
export function createAuditSink(data:Omit<AuditSink, "apiVersion" | "kind">):AuditSink{
  return {apiVersion: "auditregistration.k8s.io/v1alpha1", kind: "AuditSink", ...data}
}
...
export function createAuditSinkList(data:Omit<AuditSinkList, "apiVersion" | "kind">):AuditSinkList{
  return {apiVersion: "auditregistration.k8s.io/v1alpha1", kind: "AuditSinkList", ...data}
}
