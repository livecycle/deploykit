...
export function createRuntimeClass(data:Omit<RuntimeClass, "apiVersion" | "kind">):RuntimeClass{
...
export function createRuntimeClassList(data:Omit<RuntimeClassList, "apiVersion" | "kind">):RuntimeClassList{
  return {apiVersion: "node.k8s.io/v1alpha1", kind: "RuntimeClassList", ...data}
}
