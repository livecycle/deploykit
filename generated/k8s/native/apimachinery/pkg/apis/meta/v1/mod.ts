...
export function createAPIGroup(data:Omit<APIGroup, "apiVersion" | "kind">):APIGroup{
...
export function createAPIGroupList(data:Omit<APIGroupList, "apiVersion" | "kind">):APIGroupList{
...
export function createAPIResourceList(data:Omit<APIResourceList, "apiVersion" | "kind">):APIResourceList{
...
export function createAPIVersions(data:Omit<APIVersions, "apiVersion" | "kind">):APIVersions{
...
export function createDeleteOptions(data:Omit<DeleteOptions, "apiVersion" | "kind">):DeleteOptions{
...
export function createStatus(data:Omit<Status, "apiVersion" | "kind">):Status{
