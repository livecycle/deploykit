/* Generated for api/events/v1/mod.ts */
...
export type Event = {
  /** action is what action was takenfailed regarding to the regarding object. It is machine-readable. This field cannot be empty for new Events and it can have at most 128 characters. */
  action?: string;
...
export function createEvent<T extends Omit<Event, "apiVersion" | "kind">>(
  ...
  return { apiVersion: "events.k8s.io/v1", kind: "Event", ...data };
}
...
>(data: T): EventList & T & Pick<EventList, "apiVersion" | "kind"> {
  return { apiVersion: "events.k8s.io/v1", kind: "EventList", ...data };
}

/** EventSeries contain information on series of events, i.e. thing that wasis happening continuously for some time. How often to update the EventSeries is up to the event reporters. The default event reporter in "k8s.ioclient-gotoolseventsevent_broadcaster.go" shows how this struct is updated on heartbeats and can guide customized reporter implementations. */
