/* Generated for api/node/v1/mod.ts */
...
export type RuntimeClass = {
 ...
 https:kubernetes.iodocsconceptsscheduling-evictionpod-overhead
...
>(data: T): RuntimeClass & T & Pick<RuntimeClass, "apiVersion" | "kind"> {
  return { apiVersion: "node.k8s.io/v1", kind: "RuntimeClass", ...data };
}
...
>(
  ...
  return { apiVersion: "node.k8s.io/v1", kind: "RuntimeClassList", ...data };
}
