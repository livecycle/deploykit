...
export function createAlertmanager(data:Omit<Alertmanager, "apiVersion" | "kind">):Alertmanager{
  return {apiVersion: "monitoring.coreos.com/v1", kind: "Alertmanager", ...data}
}
...
export function createServiceMonitor(data:Omit<ServiceMonitor, "apiVersion" | "kind">):ServiceMonitor{
  return {apiVersion: "monitoring.coreos.com/v1", kind: "ServiceMonitor", ...data}
}
...
export function createPodMonitor(data:Omit<PodMonitor, "apiVersion" | "kind">):PodMonitor{
  return {apiVersion: "monitoring.coreos.com/v1", kind: "PodMonitor", ...data}
}
