/* Generated for api/batch/v2alpha1/mod.ts */
...
export type CronJob = {
  ...
  /** Specification of the desired behavior of a cron job, including the schedule. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
  spec?: CronJobSpec;

  /** Current status of a cron job. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
...
export type JobTemplateSpec = {
  /** Standard object's metadata of the jobs created from this template. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#metadata */
  metadata?: ObjectMeta;

  /** Specification of the desired behavior of the job. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
  spec?: JobSpec;
};
