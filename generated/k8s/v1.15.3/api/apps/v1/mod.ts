...
export type DaemonSet = {
  ...
  /** The desired behavior of this daemon set. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
  spec?: DaemonSetSpec;

  /** The current status of this daemon set. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
...
export type ReplicaSet = {
  ...
  /** Spec defines the specification of the desired behavior of the ReplicaSet. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
  spec?: ReplicaSetSpec;

  /** Status is the most recently observed status of the ReplicaSet. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
