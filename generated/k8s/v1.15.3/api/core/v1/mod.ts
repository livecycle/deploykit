...
export type GlusterfsPersistentVolumeSource = {
  ...
  /** EndpointsNamespace is the namespace that contains Glusterfs endpoint. If this field is empty, the EndpointNamespace defaults to the same namespace as the bound PVC. More info: https:releases.k8s.ioHEADexamplesvolumesglusterfsREADME.md#create-a-pod */
...
export type LimitRange = {
  ...
  /** Spec defines the limits enforced. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
  spec?: LimitRangeSpec;
};
...
export type LimitRangeList = {
  ...
  /** Items is a list of LimitRange objects. More info: https:kubernetes.iodocsconceptsconfigurationmanage-compute-resources-container */
  items: LimitRange[];
...
export type Namespace = {
  ...
  /** Spec defines the behavior of the Namespace. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
  spec?: NamespaceSpec;

  /** Status describes the current status of a Namespace. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
...
export type Node = {
  ...
  /** Spec defines the behavior of a node. https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
  spec?: NodeSpec;

  /** Most recently observed status of the node. Populated by the system. Read-only. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
  status?: NodeStatus;
};
...
export type NodeStatus = {
  /** List of addresses reachable to the node. Queried from cloud provider, if available. More info: https:kubernetes.iodocsconceptsnodesnode#addresses */
...
export type ObjectReference = {
  ...
  /** Specific resourceVersion to which this reference is made, if any. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#concurrency-control-and-consistency */
  resourceVersion?: string;
...
export type PersistentVolumeSpec = {
  ...
  /** Glusterfs represents a Glusterfs volume that is attached to a host and exposed to the pod. Provisioned by an admin. More info: https:releases.k8s.ioHEADexamplesvolumesglusterfsREADME.md */
  ...
  /** StorageOS represents a StorageOS volume that is attached to the kubelet's host machine and mounted into the pod More info: https:releases.k8s.ioHEADexamplesvolumesstorageosREADME.md */
...
export type Pod = {
  ...
  /** Most recently observed status of the pod. This data may not be up to date. Populated by the system. Read-only. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
  status?: PodStatus;
};
...
export type PodList = {
  ...
  /** List of pods. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md */
  items: Pod[];
...
export type PodSpec = {
  ...
  /** RuntimeClassName refers to a RuntimeClass object in the node.k8s.io group, which should be used to run this pod.  If no RuntimeClass resource matches the named class, the pod will not be run. If unset or empty, the "legacy" RuntimeClass will be used, which is an implicit class with an empty definition that uses the default runtime handler. More info: https:git.k8s.ioenhancementskepssig-noderuntime-class.md This is a beta feature as of Kubernetes v1.14. */
...
export type PodTemplate = {
  ...
  /** Template defines the pods that will be created from this pod template. https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
...
export type ReplicationController = {
  ...
  /** If the Labels of a ReplicationController are empty, they are defaulted to be the same as the Pod(s) that the replication controller manages. Standard object's metadata. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#metadata */
  metadata?: ObjectMeta;

  /** Spec defines the specification of the desired behavior of the replication controller. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
  spec?: ReplicationControllerSpec;

  /** Status is the most recently observed status of the replication controller. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
...
export type ResourceQuota = {
  ...
  /** Spec defines the desired quota. https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
  spec?: ResourceQuotaSpec;

  /** Status defines the actual enforced quota and its current usage. https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
...
export type Service = {
  ...
  /** Spec defines the behavior of a service. https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
  spec?: ServiceSpec;

  /** Most recently observed status of the service. Populated by the system. Read-only. More info: https:git.k8s.iocommunitycontributorsdevelapi-conventions.md#spec-and-status */
...
export type ServicePort = {
  ...
  /** The port on each node on which this service is exposed when type=NodePort or LoadBalancer. Usually assigned by the system. If specified, it will be allocated to the service if unused or else creation of the service will fail. Default is to auto-allocate a port if the ServiceType of this Service requires one. More info: https:kubernetes.iodocsconceptsservices-networkingservice#type-nodeport */
  nodePort?: number;
...
export type ServiceSpec = {
  ...
  /** externalName is the external reference that kubedns or equivalent will return as a CNAME record for this service. No proxying will be involved. Must be a valid RFC-1123 hostname (https:tools.ietf.orghtmlrfc1123) and requires Type to be ExternalName. */
  externalName?: string;
  ...
  /** If specified and supported by the platform, this will restrict traffic through the cloud-provider load-balancer will be restricted to the specified client IPs. This field will be ignored if the cloud-provider does not support the feature." More info: https:kubernetes.iodocstasksaccess-application-clusterconfigure-cloud-provider-firewall */
...
export type WindowsSecurityContextOptions = {
  /** GMSACredentialSpec is where the GMSA admission webhook (https:github.comkubernetes-sigswindows-gmsa) inlines the contents of the GMSA credential spec named by the GMSACredentialSpecName field. This field is alpha-level and is only honored by servers that enable the WindowsGMSA feature flag. */
