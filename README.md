...
#### deploy.ts
```typescript
import { createMicroservice } from "https://raw.githubusercontent.com/yshayy/deploykit/0.0.17/blueprint/k8s/app.ts";
import { addDeployment, addService, expose } from "https://raw.githubusercontent.com/yshayy/deploykit/0.0.17/blueprint/k8s/operators/all.ts";
