...
#### deploy.ts
```typescript
import { createMicroservice } from "https://deno.land/x/gh:yshayy:deploykit@0.0.13/blueprint/k8s/app.ts";
import { addDeployment, addService, expose } from "https://deno.land/x/gh:yshayy:deploykit@0.0.13/blueprint/k8s/operators/all.ts";
